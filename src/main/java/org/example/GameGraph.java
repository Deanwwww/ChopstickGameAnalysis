...
public class GameGraph {
     ...
     *
     * - If the current state is already a winning state, store 1 in the DP and return true. (Base Case)
     * - If we've seen this state, return the seen result. (Dynamic Programming)
